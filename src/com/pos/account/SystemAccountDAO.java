...
public class SystemAccountDAO {
	   ...
	   private static void createSystemAccount(SystemAccount act) {
	   ...
	   private static void logInSystemAccount(String userName, String password) {
	   ...
	   private static void fillAttendance(Attendance attendance) {
	   ...
	   private static  void logOutSystemAccount(Attendance attendance) {
